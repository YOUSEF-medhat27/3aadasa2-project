...
export default function Privacy() {
 ...
 <div className="bg-[#0a0a0a]">
      <header className="relative py-20 overflow-hidden mt-20">
        ...
        >
          ...
          <div
            className="inline-flex items-center justify-center w-16 h-16 bg-orange-500/10 backdrop-blur-sm rounded-2xl border border-orange-500/30 mb-6"
          >
            <svg
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div
          className="bg-orange-500/10 border border-orange-500/20 rounded-2xl p-6 mb-12"
        >
        ...
        <div className="space-y-12">
          <section className="group">
            ...
            >
              <span
                className="flex items-center justify-center w-8 h-8 bg-linear-to-br from-orange-500 to-yellow-500 text-white text-sm font-bold rounded-lg"
                >1</span
              >مقدمة
            </h2>
            <div className="pr-11">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3 text-neutral-400">
                  ...
                  ><span
                    ...
                    الاسم الأول، الاسم الأخير، اسم المستخدم أو معرف مشابه.</span
                  >
                </li>
                <li className="flex items-start gap-3 text-neutral-400">
                  <svg
                ...
                <li className="flex items-start gap-3 text-neutral-400">
                  ...
                  ><span
                    ...
                    عنوان IP، نوع المتصفح، المنطقة الزمنية، ونظام التشغيل.</span
                  >
                </li>
                <li className="flex items-start gap-3 text-neutral-400">
                  <svg
                  ...
                  ><span
                    ...
                    معلومات حول كيفية استخدامك لموقعنا وخدماتنا.</span
                  >
                </li>
              </ul>
            </div>
