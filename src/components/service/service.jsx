...
export default function service() {
  ...
  <Navbar/>
   <div class="bg-[#0a0a0a]">
      <header class="relative py-20 overflow-hidden mt-20">
        <div class="absolute inset-0 bg-[#0a0a0a]"></div>
        <div
          class="absolute inset-0 bg-[linear-gradient(rgba(38,38,38,0.5)_1px,transparent_1px),linear-gradient(90deg,rgba(38,38,38,0.5)_1px,transparent_1px)] bg-size-[60px_60px]"
        ></div>
        <div class="absolute inset-0 opacity-30">
          <div
            class="absolute bottom-20 left-20 w-72 h-72 bg-yellow-500/20 rounded-full blur-[100px]"
          ></div>
        </div>
        <div
        ...
        >
          ...
          <div
            class="inline-flex items-center justify-center w-16 h-16 bg-orange-500/10 backdrop-blur-sm rounded-2xl border border-orange-500/30 mb-6"
          >
            <svg
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div
          class="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6 mb-12"
        >
        ...
        <div class="space-y-12">
          <section class="group">
            ...
            >
              <span
                class="flex items-center justify-center w-8 h-8 bg-linear-to-br from-orange-500 to-yellow-500 text-white text-sm font-bold rounded-lg"
                >1</span
              >الموافقة على الشروط
            </h2>
            <div class="pr-11">
              <p class="text-neutral-400 leading-relaxed mb-4">
                ...
                هذه وجميع القوانين واللوائح المعمول بها. إذا لم توافق على أي من
                هذه الشروط، فأنت ممنوع من استخدام هذا الموقع أو الوصول إليه.
              </p>
            </div>
          </section>
          <section class="group">
