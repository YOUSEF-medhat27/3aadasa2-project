...
export default function Footer() {
  return <>
    ...
    <footer
      className="relative  bg-[#0a0a0a] text-neutral-300 overflow-hidden border-t border-[#262626]"
    >
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="lg:col-span-1">
            <NavLink className="flex items-center gap-3 mb-6 group"
              to="/"
            ...
            <div className="flex gap-2">
              <NavLink to="https://twitter.com/adasah"
                target="_blank"
                ...
                aria-label="twitter"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path
              ...
              <NavLink
                ...
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    ...
                    clip-rule="evenodd"
                  ></path></svg></NavLink>
              <NavLink to="https://linkedin.com/company/adasah"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#161616] border border-[#262626] hover:bg-linear-to-br hover:from-orange-500 hover:to-orange-600 hover:border-transparent rounded-xl flex items-center justify-center text-neutral-500 hover:text-white transition-all duration-300 hover:scale-110"
                aria-label="linkedin"><svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path
                    d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"
                  ></path></svg>
              </NavLink>
              <NavLink to="https://youtube.com/@adasah"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-[#161616] border border-[#262626] hover:bg-linear-to-br hover:from-orange-500 hover:to-orange-600 hover:border-transparent rounded-xl flex items-center justify-center text-neutral-500 hover:text-white transition-all duration-300 hover:scale-110"
                aria-label="youtube">
          ...
          <div>
            <h3 className="text-white font-semibold mb-6 flex items-center gap-2">
              <span
                className="w-8 h-0.5 bg-linear-to-r from-orange-500 to-yellow-500 rounded-full"
              ></span
              >استكشف
            </h3>
            <ul className="space-y-4">
              <li>
                <NavLink className="text-sm text-neutral-500 hover:text-orange-500 transition-colors duration-300 flex items-center gap-2 group"
                  to="/"
                  data-discover="true">
                  <svg
          ...
          <div>
            ...
            <form className="space-y-3">
              ...
              <button type="submit" className="w-full bg-linear-to-r py-5 rounded-full font-bold from-orange-500 to-orange-600 text-white btn-primary text-sm">
                اشترك
              </button>
            </form>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          >
            ...
            <div className="flex gap-6">
              <NavLink className="text-sm text-neutral-600 hover:text-orange-500 transition-colors duration-300"
                to="/privacy"
                data-discover="true">
                سياسة الخصوصية
              </NavLink>
